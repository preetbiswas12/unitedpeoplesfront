...
export default function ReportIssuePage() {
  ...
  return (
    <main className="min-h-screen bg-paper text-ink">
      <section className="w-full max-w-4xl mx-auto px-4 sm:px-8 lg:px-10 py-16 lg:py-24">
        ...
        <form onSubmit={handleSubmit} className="grid w-full min-w-0 gap-5 border-2 border-ink bg-paper-2 p-5 sm:p-8 shadow-[10px_10px_0_var(--color-ink)]">
          <div className="grid w-full min-w-0 gap-5 sm:grid-cols-2">
            <label className="grid w-full min-w-0 gap-2">
              ...
              <input name="name" required className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border" />
            </label>
            <label className="grid w-full min-w-0 gap-2">
              <span className="font-condensed text-[13px] uppercase tracking-[0.18em]">Phone no.</span>
              <input name="phone" required className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border" />
            </label>
          </div>
          ...
          <div className="grid w-full min-w-0 gap-5 sm:grid-cols-2">
            <label className="grid w-full min-w-0 gap-2">
              ...
              <input name="location" required className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border" />
            </label>
            <label className="grid w-full min-w-0 gap-2">
              <span className="font-condensed text-[13px] uppercase tracking-[0.18em]">Municipality</span>
              <input name="municipality" className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border" />
            </label>
          </div>
          ...
          <div className="grid w-full min-w-0 gap-5 sm:grid-cols-2">
            <label className="grid w-full min-w-0 gap-2">
              ...
              <input name="ward" className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border" />
            </label>
            <label className="grid w-full min-w-0 gap-2">
              <span className="font-condensed text-[13px] uppercase tracking-[0.18em]">Issue category</span>
              <select name="category" className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border">
          ...
          <label className="grid w-full min-w-0 gap-2">
            ...
            <textarea name="description" rows={6} required className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none resize-y box-border" />
          </label>

          <label className="grid w-full min-w-0 gap-2">
            <span className="font-condensed text-[13px] uppercase tracking-[0.18em]">Images</span>
            <input name="images" type="file" accept="image/*" multiple className="w-full min-w-0 border-2 border-ink bg-paper px-4 py-3 outline-none box-border" />
          </label>
